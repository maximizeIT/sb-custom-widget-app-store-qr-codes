...
import { CustomWidgetAppStoreQrCodesProps, CustomWidgetAppStoreQrCodes } from "./custom-widget-app-store-qr-codes";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <custom-widget-app-store-qr-codes></custom-widget-app-store-qr-codes>
   */
  return class CustomWidgetAppStoreQrCodesBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): CustomWidgetAppStoreQrCodesProps {
      const attrs = this.parseAttributes<CustomWidgetAppStoreQrCodesProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<CustomWidgetAppStoreQrCodes {...this.props} />, container);
    }
...
const blockDefinition: BlockDefinition = {
    ...
    uiSchema: uiSchema,
    label: 'DEMO: App Store QR Codes',
    iconUrl: "https://maximizeit.github.io/sb-custom-widget-app-store-qr-codes/resources/qr-codes-icon.png",
};
